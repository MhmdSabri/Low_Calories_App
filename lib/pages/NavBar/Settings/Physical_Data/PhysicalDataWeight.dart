...
class PhysicalDataWeight extends StatefulWidget {
  const PhysicalDataWeight({super.key});

  @override
  State<PhysicalDataWeight> createState() => _PhysicalDataWeightState();
}

class _PhysicalDataWeightState extends State<PhysicalDataWeight> {
  final double min = 0;

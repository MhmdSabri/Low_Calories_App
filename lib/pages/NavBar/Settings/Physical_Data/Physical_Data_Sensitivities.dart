...
class PhysicalDataSensitivities extends StatefulWidget {
  const PhysicalDataSensitivities({super.key});

  @override
  State<PhysicalDataSensitivities> createState() =>
      _PhysicalDataSensitivitiesState();
}

class _PhysicalDataSensitivitiesState extends State<PhysicalDataSensitivities> {
  String? protein;
  bool click = true;

...
class ForgotYourPasswordSettings extends StatefulWidget {
  const ForgotYourPasswordSettings({super.key});

  @override
  State<ForgotYourPasswordSettings> createState() =>
      _ForgotYourPasswordSettingsState();
}

class _ForgotYourPasswordSettingsState
    extends State<ForgotYourPasswordSettings> {
  @override
